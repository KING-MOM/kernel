...
def _parse_args(description: str = "Runtime execution bridge: send through a runtime-specific sender command and persist Kernel outbound + attribution.") -> argparse.Namespace:
